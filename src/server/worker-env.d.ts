/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: 63b433e2d7525f4fc91fc4ed25ea92e2)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "AUTH_CALLBACK_URL" | "BOT_USERNAME" | "GITHUB_APP_SLUG" | "DASHBOARD_ALLOWED_USERS" | "ENVIRONMENT" | "CF_DLQ_ID" | "APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "LLM_CONFIG_ENCRYPTION_KEY" | "CF_API_TOKEN" | "CF_ACCOUNT_ID">> {}
}
