/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: 04f99baa224e85cdbcf27424734e5633)
// Runtime types generated with workerd@1.20260625.1 2026-04-16 nodejs_compat
interface __BaseEnv_Env {
	...
	AI: Ai;
	ASSETS: Fetcher;
	APP_URL: "https://codra.tmichnicki.workers.dev";
	AUTH_CALLBACK_URL: "https://codra.tmichnicki.workers.dev/auth/github/callback";
	BITBUCKET_AUTH_CALLBACK_URL: "https://codra.tmichnicki.workers.dev/auth/bitbucket/callback";
	BOT_USERNAME: "codraapp";
	GITHUB_APP_SLUG: "CodraApp";
	...
	REVIEW_WORKFLOW: Workflow<Parameters<import("./index").ReviewWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "AUTH_CALLBACK_URL" | "BITBUCKET_AUTH_CALLBACK_URL" | "BOT_USERNAME" | "GITHUB_APP_SLUG" | "ENVIRONMENT" | "APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "LLM_CONFIG_ENCRYPTION_KEY" | "CF_API_TOKEN" | "CF_ACCOUNT_ID" | "BITBUCKET_CLIENT_ID" | "BITBUCKET_CLIENT_SECRET" | "DASHBOARD_ALLOWED_USERS">> {}
}
