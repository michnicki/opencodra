/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: e358315f0a68eb79b7ce3997ee67c82d)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_URL" | "AUTH_CALLBACK_URL" | "BOT_USERNAME" | "GITHUB_APP_SLUG" | "DASHBOARD_ALLOWED_USERS" | "ENVIRONMENT" | "APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GEMINI_API_KEY" | "NEON_DATABASE_URL" | "CF_API_TOKEN" | "CF_ACCOUNT_ID">> {}
}
