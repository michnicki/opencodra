/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/server/worker-env.d.ts` (hash: 1b220afdbc0a943194a9c16b2c0aed8f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_CALLBACK_URL" | "BOT_USERNAME" | "DASHBOARD_ALLOWED_USERS" | "ENVIRONMENT" | "APP_PRIVATE_KEY" | "GITHUB_APP_ID" | "GITHUB_APP_WEBHOOK_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GEMINI_API_KEY" | "NEON_DATABASE_URL" | "CF_API_TOKEN" | "CF_ACCOUNT_ID">> {}
}
